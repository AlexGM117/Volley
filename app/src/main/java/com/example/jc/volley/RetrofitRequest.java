...
import com.example.jc.volley.interfaces.NutriNet;
...
public class RetrofitRequest extends AppCompatActivity {
    ...
    private String TAG = RetrofitRequest.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msgRetrofit = (TextView)findViewById(R.id.msgRetrofit);

        msgRetrofit2 = (TextView)findViewById(R.id.msgRetrofit2);

        msgRetrofit3 = (TextView)findViewById(R.id.msgRetrofit3);
